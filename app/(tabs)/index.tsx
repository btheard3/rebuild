  ...
  const resources = [
    {
      ...
      category: 'Guide',
      image:
        'https://images.pexels.com/photos/1694642/pexels-photo-1694642.jpeg',
    ...
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/5699398/pexels-photo-5699398.jpeg',
...
const styles = StyleSheet.create({
  ...
  statusText: { fontWeight: '600', marginLeft: 4 },
  ...
  resourceCard: { borderRadius: 12, overflow: 'hidden', borderWidth: 1 },
  resourceImage: { width: '100%', height: 150 },
  resourceContent: { padding: 12 },
  resourceCategory: { fontSize: 12, fontWeight: '600', marginBottom: 4 },
