  ...
  const renderFormStep = () => (
    <ScrollView style={styles.formContainer} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Full Legal Name *</Text>
        <TextInput
          style={[styles.input, { 
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Government ID Number *</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.sectionHeader}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: 'Inter-Bold' }]}>Insurance Information</Text>
      </View>

      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Insurance Provider *</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Policy Number *</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Primary Contact Name *</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Primary Contact Phone *</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Secondary Contact Name</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Secondary Contact Phone</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.sectionHeader}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: 'Inter-Bold' }]}>Current Address</Text>
      </View>

      <View style={styles.inputGroup}>
        <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>Street Address *</Text>
        <TextInput
          style={[styles.input, { 
            backgroundColor: colors.surface, 
            color: colors.text, 
      ...
      <View style={styles.row}>
        <View style={[styles.inputGroup, { flex: 2, marginRight: 8 }]}>
          <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>City *</Text>
          <TextInput
            style={[styles.input, { 
              backgroundColor: colors.surface, 
              color: colors.text, 
        ...
        <View style={[styles.inputGroup, { flex: 1, marginRight: 8 }]}>
          <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>State *</Text>
          <TextInput
            style={[styles.input, { 
              backgroundColor: colors.surface, 
              color: colors.text, 
        ...
        <View style={[styles.inputGroup, { flex: 1 }]}>
          <Text style={[styles.label, { color: colors.text, fontFamily: 'Inter-Medium' }]}>ZIP *</Text>
          <TextInput
            style={[styles.input, { 
              backgroundColor: colors.surface, 
              color: colors.text, 
      ...
      >
        {isProcessing ? (
          ...
          <>
            ...
            <Text style={[styles.createBackupButtonText, { fontFamily: 'Inter-SemiBold' }]}>Create Blockchain Backup</Text>
          </>
        )}
      </TouchableOpacity>
    </ScrollView>
  ...
  const renderBackupStep = () => (
    <ScrollView style={styles.backupContainer} showsVerticalScrollIndicator={false}>
      <View style={[styles.backupHeader, { backgroundColor: colors.primary + '20' }]}>
        ...
        <Text style={[styles.backupTitle, { color: colors.text, fontFamily: 'Inter-Bold' }]}>Identity Backup Created</Text>
        <Text style={[styles.backupSubtitle, { color: colors.textSecondary, fontFamily: 'Inter-Regular' }]}>
      ...
      <View style={[styles.backupCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        <View style={styles.backupDetail}>
          <Text style={[styles.backupLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Data Hash</Text>
          <View style={styles.hashContainer}>
            <Text style={[styles.hashText, { color: colors.text, fontFamily: 'monospace' }]}>
        ...
        <View style={styles.backupDetail}>
          <Text style={[styles.backupLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Transaction ID</Text>
          <View style={styles.hashContainer}>
            <Text style={[styles.hashText, { color: colors.text, fontFamily: 'monospace' }]}>
        ...
        <View style={styles.backupDetail}>
          <Text style={[styles.backupLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Timestamp</Text>
          <Text style={[styles.backupValue, { color: colors.text, fontFamily: 'Inter-Regular' }]}>
            {backup ? backup.timestamp.toLocaleString() : 'N/A'}
          </Text>
        </View>

        <View style={styles.backupDetail}>
          <Text style={[styles.backupLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Status</Text>
      ...
      <View style={styles.actionButtons}>
        ...
        >
          {isVerifying ? (
            ...
            <>
              ...
              <Text style={[styles.actionButtonText, { fontFamily: 'Inter-SemiBold' }]}>Verify Backup</Text>
            </>
          )}
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={[styles.actionButtonText, { fontFamily: 'Inter-SemiBold' }]}>View on AlgoExplorer</Text>
        </TouchableOpacity>
      </View>

      <View style={[styles.infoCard, { backgroundColor: colors.info + '20', borderColor: colors.info }]}>
        <Text style={[styles.infoTitle, { color: colors.info, fontFamily: 'Inter-Bold' }]}>How Blockchain Verification Works</Text>
  ...
  const renderVerifiedStep = () => (
    <ScrollView style={styles.verifiedContainer} showsVerticalScrollIndicator={false}>
      <View style={[styles.verifiedHeader, { backgroundColor: colors.success + '20' }]}>
        ...
        <Text style={[styles.verifiedTitle, { color: colors.text, fontFamily: 'Inter-Bold' }]}>Verification Successful</Text>
        <Text style={[styles.verifiedSubtitle, { color: colors.textSecondary, fontFamily: 'Inter-Regular' }]}>
      ...
      <View style={[styles.verifiedCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        <View style={styles.verifiedDetail}>
          <Text style={[styles.verifiedLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Verification Status</Text>
          <View style={[styles.verifiedBadge, { backgroundColor: colors.success + '20' }]}>
            <CheckCircle size={16} color={colors.success} />
            <Text style={[styles.verifiedBadgeText, { color: colors.success, fontFamily: 'Inter-SemiBold' }]}>VERIFIED</Text>
          </View>
        </View>

        <View style={styles.verifiedDetail}>
          <Text style={[styles.verifiedLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Data Hash</Text>
          <View style={styles.hashContainer}>
            <Text style={[styles.hashText, { color: colors.text, fontFamily: 'monospace' }]}>
              {backup ? formatHash(backup.hash) : 'N/A'}
            </Text>
        ...
        <View style={styles.verifiedDetail}>
          <Text style={[styles.verifiedLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Transaction ID</Text>
          <View style={styles.hashContainer}>
            <Text style={[styles.hashText, { color: colors.text, fontFamily: 'monospace' }]}>
              {backup ? formatTransactionId(backup.transactionId) : 'N/A'}
            </Text>
        ...
        <View style={styles.verifiedDetail}>
          <Text style={[styles.verifiedLabel, { color: colors.textSecondary, fontFamily: 'Inter-Medium' }]}>Verification Time</Text>
          <View style={styles.timeContainer}>
            <Clock size={16} color={colors.textSecondary} />
            <Text style={[styles.verifiedValue, { color: colors.text, fontFamily: 'Inter-Regular' }]}>
      ...
      <View style={styles.actionButtons}>
        ...
        >
          ...
          <Text style={[styles.actionButtonText, { fontFamily: 'Inter-SemiBold' }]}>Edit Information</Text>
        </TouchableOpacity>
      </View>

      <View style={[styles.securityCard, { backgroundColor: colors.success + '20', borderColor: colors.success }]}>
        <Text style={[styles.securityTitle, { color: colors.success, fontFamily: 'Inter-Bold' }]}>Your Data is Secure</Text>
        <Text style={[styles.securityText, { color: colors.text, fontFamily: 'Inter-Regular' }]}>
      ...
      <TouchableOpacity
        style={[styles.emergencyModeButton, { backgroundColor: colors.error }]}
        onPress={() => router.push('/identity-vault/emergency-mode')}
      >
        <AlertTriangle size={20} color="white" />
        <Text style={[styles.emergencyModeButtonText, { fontFamily: 'Inter-SemiBold' }]}>Enter Emergency Mode</Text>
      </TouchableOpacity>
    </ScrollView>
  );
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        <View style={styles.headerContent}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text, fontFamily: 'Inter-Bold' }]}>Identity Vault</Text>
        </View>
      </View>
